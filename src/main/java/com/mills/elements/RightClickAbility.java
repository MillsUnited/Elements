...
public class RightClickAbility {
    private final String abilityName;
    private final long cooldownMillis; // Cooldown in milliseconds
    ...
    public RightClickAbility(String abilityName, Consumer<Player> abilityAction, long cooldownSeconds, ItemStack requiredItem) {
